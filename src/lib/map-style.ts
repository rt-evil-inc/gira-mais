		...
		'layers': [
			...
			},
			{
				...
				'filter': [
					...
					[
						'match',
						['get', 'class'],
						['national_park', 'nature_reserve', 'protected_area', 'conservation'],
						true,
						false,
					],
				],
			...
			},
			{
				...
				'paint': {
					...
					'fill-opacity': ['interpolate', ['linear'], ['zoom'], 12, 0, 12.5, 1],
				},
			},
			{
				'id': 'water',
			...
			},
			{
				...
				'paint': {
					...
					'fill-opacity': ['interpolate', ['linear'], ['zoom'], 14.5, 0, 15, 1, 15.5, 1, 22, 0.1],
				},
			},
			{
				'id': 'building-3d',
